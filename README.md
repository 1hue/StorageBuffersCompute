...
Usage of **Specialization Constant** -- which are a more efficient to pass data in than Push Constants for data that not need change during runtime -- is also included.
